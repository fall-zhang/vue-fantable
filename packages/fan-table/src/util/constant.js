...
export const COMPS_NAME = {
  ...
  FAN_TABLE_BODY: 'FanTableBody',
  FAN_TABLE_BODY_TR: 'FanTableBodyTr',
  FAN_TABLE_BODY_TR_SCROLLING: 'FanTableBodyTrScrolling',
  FAN_TABLE_BODY_CHECKBOX_CONTENT: 'FanTableBodyCheckboxContent',
  FAN_TABLE_BODY_RADIO_CONTENT: 'FanTableBodyRadioContent',
  FAN_TABLE_BODY_TD: 'FanTableBodyTd',

  FAN_TABLE_COLGROUP: 'FanTableColgroup',
  FAN_TABLE_FOOTER: 'FanTableFooter',

  FAN_TABLE_EXPAND_TR: 'FanTableExpandTr',
  FAN_TABLE_EXPAND_TR_ICON: 'FanTableExpandTrIcon',

  FAN_TABLE_EDIT_INPUT: 'FanTableEditInput',

  FAN_TABLE_SELECTION: 'FanTableSelection',

  FAN_TABLE_COLUMN_RESISZER: 'FanTableColumnResizer',
}
