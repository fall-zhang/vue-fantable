...
:::
`)])],-1),B=n("p",null,"fan-table/contextmenu/custom-menu",-1),W={__name:"custom",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const e=s("vue-anchor"),p=s("demo-block");return l(),r("div",K,[a(e,{"is-edit":"",label:"自定义右键菜单",fileName:""}),t(),a(p,{filePath:"fan-table/contextmenu/custom-menu",sourceCode:""},{code:c(()=>[D]),default:c(()=>[B]),_:1})])}}},U={name:"BasicMain",components:{Explain:I,ContextmenuTypes:T,Base:N,Custom:W,API1:b,API2:R}},q=n("h2",null,"右键菜单",-1);function F(u,o,k,i,y,e){const p=s("Explain"),g=s("ContextmenuTypes"),d=s("Base"),m=s("Custom"),f=s("API1"),x=s("API2");return l(),r("div",null,[q,a(p),a(g),a(d),a(m),a(f,{anchor:"API contextmenuHeaderOption",desc:"contextmenuHeaderOption header 右键菜单配置"}),a(x,{anchor:"API contextmenuBodyOption",desc:"contextmenuBodyOption body 右键菜单配置"})])}const G=h(U,[["render",F]]);export{G as default};
