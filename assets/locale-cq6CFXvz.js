...
&lt;script&gt;
  ...
  */
&lt;/script&gt;
</code></pre>`,2),g=s('<p>目前支持以下语言：</p><table class="md-it-table"><thead><tr><th>语言</th><th>文件名</th></tr></thead><tbody><tr><td>简体中文</td><td>zh-CN</td></tr><tr><td>繁體中文（中国台湾）</td><td>zh-TW</td></tr><tr><td>英语（en）</td><td>en-US</td></tr><tr><td>南非（荷兰语）</td><td>af-ZA</td></tr><tr><td>南非（ZA）</td><td>zu-ZA</td></tr><tr><td>法语（FR）</td><td>fr-FR</td></tr><tr><td>巴西葡萄牙语</td><td>pt-BR</td></tr><tr><td>韩文(KR)</td><td>ko-KR</td></tr><tr><td>俄语(RU)</td><td>ru-RU</td></tr></tbody></table><p>如果你需要使用其他的语言，欢迎贡献 PR：只需在 <a href="https://github.com/fall-zhang/vue-fantable/tree/master/packages/src/locale/lang">这里</a> 添加一个语言配置文件即可。</p>',3),v={__name:"locale",setup(b,{expose:e}){return e({frontmatter:{}}),(f,h)=>{const t=l("vue-anchor");return o(),p("div",r,[u,a(t,{"is-edit":"",label:"语言切换",fileName:""}),n(),d,a(t,{"is-edit":"",label:"修改语言包",fileName:""}),n(),i,a(t,{"is-edit":"",label:"CDN 方式加载语言文件",fileName:""}),n(),k,a(t,{"is-edit":"",label:"语言包",fileName:""}),n(),g])}}};export{v as default};
