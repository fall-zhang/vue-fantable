import{o as r,a as l,e as n,d as s,r as a,b as t,w as e,_ as m}from"./index-P7Lzo4Rg.js";const b={class:"markdown-body"},_=n("div",{class:"tip"},[n("p",null,[s("1、虚拟滚动的行序号 "),n("a",{href:"#/zh/doc/table/virtual-scroll?anchor=xing-xu-hao-wen-ti"},"参考这里")])],-1),h=[_],w={__name:"explain",setup(k,{expose:o}){return o({frontmatter:{}}),(i,y)=>(r(),l("div",b,h))}},f={class:"markdown-body"},v=n("p",null,[s("行序号没有提供 API,而是通过"),n("code",null,"renderBodyCell"),s("渲染函数的方式实现，这样会更灵活")],-1),x=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
:::
`)])],-1),B=n("p",null,"fan-table/row-index/row-ranking",-1),K={__name:"ranking",setup(k,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),p=a("demo-block");return r(),l("div",$,[t(c,{"is-edit":"",label:"排名场景",fileName:""}),s(),t(p,{filePath:"fan-table/row-index/row-ranking",sourceCode:""},{code:e(()=>[A]),default:e(()=>[B]),_:1})])}}},I={name:"BasicMain",components:{Explain:w,Base:N,Ranking:K}},q=n("h2",null,"行序号",-1);function j(k,o,u,i,y,c){const p=a("Explain"),d=a("Base"),g=a("Ranking");return r(),l("div",null,[q,t(p),t(d),t(g)])}const E=m(I,[["render",j]]);export{E as default};
