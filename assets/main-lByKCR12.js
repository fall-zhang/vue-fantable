import{o as l,a as r,ap as C,r as a,b as t,d as s,w as o,e as n,_ as K}from"./index-y7N75Dfv.js";import{E as A}from"./expand-option-props-oEBsg22M.js";import"./api-tpl-B1oQ130I.js";import"./db-iDr7ZxWF.js";const q={class:"markdown-body"},N=C('<div class="tip"><p>1、通过 <code>expandOption</code>属性配置展开行功能<br> 2、通过在<code>columns</code> 设置<code>type=expand</code>展开的列 3、设置<code>rowKeyFieldName</code>属性对应行数据的列名<br> 4、<code>render</code>函数允许自定义展开内容，此处为 jsx 语法<br></p></div>',1),E=[N],$={__name:"explain",setup(k,{expose:p}){return p({frontmatter:{}}),(i,y)=>(l(),r("div",q,E))}},I={class:"markdown-body"},D=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
