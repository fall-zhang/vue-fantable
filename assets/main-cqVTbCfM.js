import{o as r,a as l,ao as h,r as a,b as t,d as s,w as o,e as n,_ as w}from"./index-X6yBs7pR.js";import{S as _}from"./sort-option-props-N8GeWXED.js";import"./api-tpl-g6V9uJDd.js";import"./db-bVyod2if.js";const f={class:"markdown-body"},v=h('<div class="tip"><p>1、通过 <code>sortBy</code>属性，设置需要排序的列。<code>sortBy=&quot;asc&quot;</code>：默认当前列升序；<code>sortBy=&quot;desc&quot;</code>：默认当前列降序；<code>sortBy=&quot;&quot;</code>：允许排序但无排序规则<br> 2、通过 <code>sortOption</code>对象，设置更多排序功能。排序功能需要配合<code>sortChange(param)</code>回调函数实现，回调参数包含列的排序规则</p></div>',1),C=[v],A={__name:"explain",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>(r(),l("div",f,C))}},N={class:"markdown-body"},S=n("p",null,[s("1、默认为单字段排序<br>2、"),n("code",null,"sortChange(params)"),s("回调函数接收列的排序规则")],-1),x=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])],-1),$=n("p",null,"fan-table/header-sort/single-sort",-1),q={__name:"single-sort",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return r(),l("div",N,[t(c,{"is-edit":"",label:"单字段排序",fileName:""}),s(),t(e,{filePath:"fan-table/header-sort/single-sort",sourceCode:""},{description:o(()=>[S]),code:o(()=>[x]),default:o(()=>[$]),_:1})])}}},B={class:"markdown-body"},D=n("p",null,[s("1、通过"),n("code",null,"multipleSort=true"),s("开启多字段排序<br>2、排序字段的优先级需要自己指定，此处只是示例，具体逻辑自行实现（一般由后端服务返回）")],-1),O=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("fan-table")]),s(),n("span",{class:"token attr-name"},":columns"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("columns"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":table-data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("tableData"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":sort-option"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("sortOption"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},"border-y"),s(),n("span",{class:"token punctuation"},"/>")]),s(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1),P=n("p",null,"fan-table/header-sort/multi-sort",-1),j={__name:"multi-sort",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return r(),l("div",B,[t(c,{"is-edit":"",label:"多字段排序",fileName:""}),s(),t(e,{filePath:"fan-table/header-sort/multi-sort",sourceCode:""},{description:o(()=>[D]),code:o(()=>[O]),default:o(()=>[P]),_:1})])}}},J={class:"markdown-body"},I=n("p",null,[s("1、通过"),n("code",null,"sortAlways=true"),s("允许排序只在升序和降序切换")],-1),E=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("fan-table")]),s(),n("span",{class:"token attr-name"},":columns"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("columns"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":table-data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("tableData"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":sort-option"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("sortOption"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},"border-y"),s(),n("span",{class:"token punctuation"},"/>")]),s(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1),M=n("p",null,"fan-table/header-sort/sort-always",-1),V={__name:"sort-always",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return r(),l("div",J,[t(c,{"is-edit":"",label:"排序切换",fileName:""}),s(),t(e,{filePath:"fan-table/header-sort/sort-always",sourceCode:""},{description:o(()=>[I]),code:o(()=>[E]),default:o(()=>[M]),_:1})])}}},z={name:"BasicMain",components:{Explain:A,SingleSort:q,MultiSort:j,SortAlways:V,API:_}},G=n("h2",null,"排序",-1);function H(u,p,k,i,y,c){const e=a("Explain"),g=a("SingleSort"),d=a("MultiSort"),m=a("SortAlways"),b=a("API");return r(),l("div",null,[G,t(e),t(g),t(d),t(m),t(b,{title:"API",anchor:"API",desc:"sortOption 排序配置"})])}const F=w(z,[["render",H]]);export{F as default};
