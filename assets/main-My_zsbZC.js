import{o as r,a as l,ap as b,r as a,b as t,d as s,w as o,e as n,_}from"./index-g2bFAzY6.js";import{R as w}from"./row-style-option-props-2YF_zIiH.js";import"./api-tpl-7T6V_5eZ.js";import"./db-jGcA6pVs.js";const f={class:"markdown-body"},v=b('<div class="tip"><p>1、通过属性<code>rowStyleOption</code>设置行的样式<br> 2、通过属性<code>stripe=true</code>开启斑马纹<br> 3、通过属性<code>hoverHighlight=true</code>开启行 hover 高亮效果。默认开启<br> 4、通过属性<code>clickHighlight=true</code>开启行 click 高亮效果。默认开启</p></div>',1),C=[v],x={__name:"explain",setup(k,{expose:p}){return p({frontmatter:{}}),(i,y)=>(r(),l("div",f,C))}},N={class:"markdown-body"},A=n("p",null,[s("通过属性"),n("code",null,"stripe"),s("开启斑马纹")],-1),$=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
