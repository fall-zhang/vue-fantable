import{o as l,a as r,e as n,d as s,r as a,b as t,w as p,_ as f}from"./index-CTvFp2KQ.js";import{F as h}from"./filter-custom-props-DQoem9kc.js";import"./api-tpl-71NErj1k.js";import"./db-DSTa4-Fv.js";const b={class:"markdown-body"},_=n("div",{class:"tip"},[n("p",null,[s("1、In order to meet the needs of more scenarios, the filtering custom function is opened.Filtering custom needs to implement interaction logic by itself"),n("br"),s(" 2、Filter custom functions by setting the ‘filterCustom’ property of the ‘column’ object"),n("br")])],-1),w=[_],v={__name:"explain",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>(l(),r("div",b,w))}},C={class:"markdown-body"},x=n("p",null,[s("1、"),n("code",null,"defaultVisible"),s(" Specifies whether to expand by default<br>2、"),n("code",null,"render"),s("Render functions,Specifies filtering custom content.The parameter 'showFn' is the display drop-down function、The parameter "),n("code",null,"closeFn"),s(" is to close the drop-down function")],-1),F=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
              ...
              `),n("span",{class:"token keyword"},"return"),s(),n("span",{class:"token punctuation"},"("),s(`
                `),n("span",{class:"token operator"},"<"),s("div "),n("span",{class:"token keyword"},"class"),n("span",{class:"token operator"},"="),n("span",{class:"token string"},'"custom-name-filter"'),n("span",{class:"token operator"},">"),s(`
                  `),n("span",{class:"token operator"},"<"),s(`input
                    ...
                    onInput`),n("span",{class:"token operator"},"="),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},"e"),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token operator"},"=>"),s(),n("span",{class:"token punctuation"},"("),n("span",{class:"token keyword"},"this"),n("span",{class:"token punctuation"},"."),s("searchValue "),n("span",{class:"token operator"},"="),s(" e"),n("span",{class:"token punctuation"},"."),s("target"),n("span",{class:"token punctuation"},"."),s("value"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},"}"),s(`
                  ...
                  `),n("span",{class:"token operator"},"<"),s("div "),n("span",{class:"token keyword"},"class"),n("span",{class:"token operator"},"="),n("span",{class:"token string"},'"custom-name-filter-operation"'),n("span",{class:"token operator"},">"),s(`
                    `),n("span",{class:"token operator"},"<"),s(`span
                      ...
                      onClick`),n("span",{class:"token operator"},"="),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token operator"},"=>"),s(),n("span",{class:"token keyword"},"this"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"searchCancel"),n("span",{class:"token punctuation"},"("),s("closeFn"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},"}"),s(`
                    ...
                    `),n("span",{class:"token operator"},"<"),s(`span
                      ...
                      onClick`),n("span",{class:"token operator"},"="),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token operator"},"=>"),s(),n("span",{class:"token keyword"},"this"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"searchConfirm"),n("span",{class:"token punctuation"},"("),s("closeFn"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},"}"),s(`
                    `),n("span",{class:"token operator"},">"),s(`
                                                查询
                    `),n("span",{class:"token operator"},"<"),n("span",{class:"token operator"},"/"),s("span"),n("span",{class:"token operator"},">"),s(`
...
`)])],-1),V=n("p",null,"fan-table/header-filter-custom/single-filter",-1),D={__name:"single-filter",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return l(),r("div",C,[t(c,{"is-edit":"",label:"Single Condition Filter",fileName:""}),s(),t(e,{filePath:"fan-table/header-filter-custom/single-filter",sourceCode:""},{description:p(()=>[x]),code:p(()=>[F]),default:p(()=>[V]),_:1})])}}},A={class:"markdown-body"},N=n("p",null,[s("filterIcon function Support to return custom icon. The built-in "),n("code",null,'<ve-icon name="search" />'),s(" icon is used here,You can also use other icon libraries")],-1),$=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("fan-table")]),s(),n("span",{class:"token attr-name"},":max-height"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("300"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":fixed-header"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("true"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":columns"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("columns"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},":table-data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("tableData"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token punctuation"},"/>")]),s(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("style")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1),I=n("p",null,"fan-table/header-filter-custom/custom-icon",-1),q={__name:"custom-icon",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return l(),r("div",A,[t(c,{"is-edit":"",label:"Custom Icon",fileName:""}),s(),N,t(e,{filePath:"fan-table/header-filter-custom/custom-icon",sourceCode:""},{code:p(()=>[$]),default:p(()=>[I]),_:1})])}}},S={name:"basic-main",components:{Explain:v,SingleFilter:D,CustomIcon:q,API:h}},K=n("h2",null,"Filter Custom",-1);function P(u,o,k,i,y,c){const e=a("Explain"),d=a("SingleFilter"),m=a("CustomIcon"),g=a("API");return l(),r("div",null,[K,t(e),t(d),t(m),t(g,{title:"API",anchor:"API",desc:"filterCustom Custom filter option"})])}const J=f(S,[["render",P]]);export{J as default};
