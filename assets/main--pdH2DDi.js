import{o as r,a as l,ap as h,r as a,b as t,d as s,w as o,e as n,_ as w}from"./index-g2bFAzY6.js";import{S as _}from"./sort-option-props-XOtiysii.js";import"./api-tpl-7T6V_5eZ.js";import"./db-jGcA6pVs.js";const f={class:"markdown-body"},v=h('<div class="tip"><p>1、通过 <code>sortBy</code>属性，设置需要排序的列。<code>sortBy=&quot;asc&quot;</code>：默认当前列升序；<code>sortBy=&quot;desc&quot;</code>：默认当前列降序；<code>sortBy=&quot;&quot;</code>：允许排序但无排序规则<br> 2、通过 <code>sortOption</code>对象，设置更多排序功能。排序功能需要配合<code>sortChange(param)</code>回调函数实现，回调参数包含列的排序规则</p></div>',1),C=[v],A={__name:"explain",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>(r(),l("div",f,C))}},N={class:"markdown-body"},S=n("p",null,[s("1、默认为单字段排序<br>2、"),n("code",null,"sortChange(params)"),s("回调函数接收列的排序规则")],-1),x=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
