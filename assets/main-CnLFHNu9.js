import{o as l,a as r,e as n,d as s,r as a,b as t,w as o,_ as v}from"./index-QNTyIAJW.js";import{_ as D}from"./custom-cell-IjD_lqny.js";import{_ as $}from"./cell-style-mnW1n9e5.js";import{_ as F}from"./cell-span-lw_EbBbI.js";import{_ as C,a as q}from"./on-footer-cell-0V_sbdGG.js";import{_ as K}from"./virtual-scroll-gfd3d2lo.js";const N={class:"markdown-body"},S=n("div",{class:"tip"},[n("p",null,[s("1、footer 汇总，允许对表格数据进行汇总展示"),n("br"),s(" 2、"),n("code",null,"footerData"),s("为 footer 汇总数据。数据结构与"),n("code",null,"tableData"),s("保持一致")])],-1),T=[S],B={__name:"explain",setup(u,{expose:p}){return p({frontmatter:{}}),(i,y)=>(l(),r("div",N,T))}},O={class:"markdown-body"},V=n("p",null,"1、默认汇总数据固定在底部",-1),E=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
