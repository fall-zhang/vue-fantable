import{o as l,a as r,aq as f,r as a,b as t,d as s,w as o,e as n,_ as v}from"./index-crzR-Bjn.js";import{R as K}from"./radio-option-props-xOqq0uzM.js";import"./api-tpl-1c2eM7M4.js";import"./db-dMNaiDz6.js";const C={class:"markdown-body"},R=f('<div class="tip"><p>1、Use the <code>radioOption</code> attribute to enable the row radio.<br> 2、Set <code>type=radio</code> in <code>columns</code> as a radio column<br> 3、The <code>rowKeyFieldName</code> property must be set<br> 4、<code>Selectedrowchange</code> is row change event.Event receives 1 parameter,<code>row</code>:current row data</p></div>',1),N=[R],A={__name:"explain",setup(k,{expose:e}){return e({frontmatter:{}}),(i,y)=>(l(),r("div",C,N))}},S={class:"markdown-body"},q=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
