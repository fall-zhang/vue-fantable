...
`)],-1),_=n(`<p>The style of vue-fantable uses less as the development language,A series of global / component style variables are defined,You can adjust to your needs.</p><h4 id="choose-blue-theme-to-customize" tabindex="-1">Choose Blue Theme To Customize</h4><p>If the theme you need is close to the blue theme,You can choose to customize according to the blue theme.All blue theme style variables <strong><a href="https://github.com/fall-zhang/vue-fantable/blob/master/packages/theme-default/var.less">Can Be Found Here</a>.</strong></p><p>Create a less variable file,For example “vue-fantable-variables.less”,Introduce this file overlay var.less The variables in.</p><pre><code>@import &#39;~vue-fantable/packages/theme-default/index.less&#39;; // import the official less style entry file
...
Vue.use(VueFantable)
</code></pre>`,13),C={__name:"theme",setup(y,{expose:s}){return s({frontmatter:{}}),(g,x)=>{const t=i("vue-anchor");return l(),r("div",h,[d,o(t,{"is-edit":"",label:"Built in themes",fileName:""}),a(),m,u,c,p,f,b,v,o(t,{"is-edit":"",label:"Theme Custom",fileName:""}),a(),_])}}};export{C as default};
