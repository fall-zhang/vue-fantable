import{o as l,a as r,aq as f,r as a,b as t,d as s,w as o,e as n,_ as v}from"./index-D9DAe906.js";import{R as K}from"./radio-option-props-CsAvnN-y.js";import"./api-tpl-D6GOwllB.js";import"./db-CYIwTn5T.js";const C={class:"markdown-body"},N=f('<div class="tip"><p>1、通过 <code>radioOption</code> 属性开启单选功能。<br> 2、通过在<code>columns</code> 设置<code>type=radio</code>作为单选的列<br> 3、设置<code>rowKeyFieldName</code>属性对应行数据的列名<br> 4、<code>selectedRowChange</code>行改变事件。事件接收 1 个参数，<code>row</code>:当前行数据</p></div>',1),R=[N],q={__name:"explain",setup(k,{expose:p}){return p({frontmatter:{}}),(i,y)=>(l(),r("div",C,R))}},A={class:"markdown-body"},S=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
