import{r as t,o as l,a as r,b as o,d as s,w as a,e as n}from"./index-BWOAprk1.js";const u={class:"markdown-body"},k=n("p",null,[s("设置 footer 汇总第 1 行"),n("code",null,"date"),s("列和"),n("code",null,"hoby"),s("列合并。 同时需要指定第 2 行"),n("code",null,"hoby"),s("列不渲染")],-1),i=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
:::
`)])],-1),y=n("p",null,"fan-table/footer-summary/cell-span",-1),h={__name:"cell-span",setup(d,{expose:p}){return p({frontmatter:{}}),(g,b)=>{const e=t("vue-anchor"),c=t("demo-block");return l(),r("div",u,[o(e,{"is-edit":"",label:"footer 列合并",fileName:""}),s(),o(c,{filePath:"fan-table/footer-summary/cell-span",sourceCode:""},{description:a(()=>[k]),code:a(()=>[i]),default:a(()=>[y]),_:1})])}}};export{h as _};
