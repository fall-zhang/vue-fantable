import{o as u,a as r,b as a,d as s,w as o,e as n,aq as p,r as e}from"./index-CTvFp2KQ.js";const k={class:"markdown-body"},i=n("h2",{id:"%E5%BF%AB%E9%80%9F%E5%BC%80%E5%A7%8B",tabindex:"-1"},"快速开始",-1),g=p(`<pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> vue-fantable
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
</code></pre>`,4),_={__name:"start",setup(b,{expose:c}){return c({frontmatter:{}}),(f,v)=>{const t=e("vue-anchor"),l=e("demo-block");return u(),r("div",k,[i,a(t,{"is-edit":"",label:"npm & yarn 安装",fileName:""}),s(),g,a(t,{"is-edit":"",label:"使用",fileName:""}),s(),y,a(l,{filePath:"start-example",sourceCode:""},{code:o(()=>[d]),default:o(()=>[q]),_:1}),a(t,{"is-edit":"",label:"CDN 方式使用",fileName:""}),s(),m])}}};export{_ as default};
