...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1),w=n("p",null,"fan-table/footer-summary/on-footer-cell",-1),_={__name:"on-footer-cell",setup(r,{expose:p}){return p({frontmatter:{}}),(i,y)=>{const e=a("vue-anchor"),c=a("demo-block");return l(),u("div",g,[t(e,{"is-edit":"",label:"footer 列事件自定义",fileName:""}),s(),t(c,{filePath:"fan-table/footer-summary/on-footer-cell",sourceCode:""},{code:o(()=>[b]),default:o(()=>[w]),_:1})])}}};export{h as _,_ as a};
