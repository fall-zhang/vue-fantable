...
`)])],-1),D=n("p",null,"fan-table/header-grouping/grouping-header",-1),q={__name:"grouping-header",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return l(),r("div",x,[t(c,{"is-edit":"",label:"表头分组",fileName:""}),s(),t(e,{filePath:"fan-table/header-grouping/grouping-header",sourceCode:""},{description:p(()=>[v]),code:p(()=>[$]),default:p(()=>[D]),_:1})])}}},C={class:"markdown-body"},G=n("p",null,[s("1、通过"),n("code",null,'fixed:"left"'),s("设置固定左列<br>2、固定列只需指定到顶层列即可")],-1),H=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1),N=n("p",null,"fan-table/header-grouping/grouping-header-fixed-column",-1),T={__name:"grouping-header-fixed-column",setup(u,{expose:o}){return o({frontmatter:{}}),(i,y)=>{const c=a("vue-anchor"),e=a("demo-block");return l(),r("div",C,[t(c,{"is-edit":"",label:"表头分组结合固定列",fileName:""}),s(),t(e,{filePath:"fan-table/header-grouping/grouping-header-fixed-column",sourceCode:""},{description:p(()=>[G]),code:p(()=>[H]),default:p(()=>[N]),_:1})])}}},B={name:"BasicMain",components:{Explain:w,GroupingHeader:q,GroupingHeaderFixedColumn:T}},E=n("h2",null,"表头分组",-1);function V(u,o,k,i,y,c){const e=a("Explain"),d=a("GroupingHeader"),g=a("GroupingHeaderFixedColumn");return l(),r("div",null,[E,t(e),t(d),t(g)])}const j=_(B,[["render",V]]);export{j as default};
