import{r as t,o as l,a as r,b as o,d as s,w as a,e as n}from"./index-P7Lzo4Rg.js";const u={class:"markdown-body"},k=n("p",null,[s("Set the "),n("code",null,"date"),s(" column and "),n("code",null,"hoby"),s(" column in the first row of footer summary to merge. At the same time, you need to specify that the "),n("code",null,"hoby"),s(" column in the second row will not be rendered")],-1),i=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("fan-table")]),s(`
        ...
        `),n("span",{class:"token attr-name"},":cell-span-option"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("cellSpanOption"),n("span",{class:"token punctuation"},'"')]),s(`
...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"default"),s(),n("span",{class:"token punctuation"},"{"),s(`
  `),n("span",{class:"token function"},"data"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
    `),n("span",{class:"token keyword"},"return"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token literal-property property"},"cellSpanOption"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"{"),s(`
        `),n("span",{class:"token literal-property property"},"footerCellSpan"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token keyword"},"this"),n("span",{class:"token punctuation"},"."),s("footerCellSpan"),n("span",{class:"token punctuation"},","),s(`
  ...
  `),n("span",{class:"token literal-property property"},"methods"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"{"),s(`
    `),n("span",{class:"token comment"},"// footer cell span"),s(`
    `),n("span",{class:"token function"},"footerCellSpan"),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},[n("span",{class:"token punctuation"},"{"),s(" row"),n("span",{class:"token punctuation"},","),s(" column"),n("span",{class:"token punctuation"},","),s(" rowIndex "),n("span",{class:"token punctuation"},"}")]),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
...
:::
`)])],-1),y=n("p",null,"fan-table/footer-summary/cell-span",-1),f={__name:"cell-span",setup(d,{expose:p}){return p({frontmatter:{}}),(g,b)=>{const e=t("vue-anchor"),c=t("demo-block");return l(),r("div",u,[o(e,{"is-edit":"",label:"Footer Column Span",fileName:""}),s(),o(c,{filePath:"fan-table/footer-summary/cell-span",sourceCode:""},{description:a(()=>[k]),code:a(()=>[i]),default:a(()=>[y]),_:1})])}}};export{f as _};
