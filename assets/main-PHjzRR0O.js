import{o as e,a as c,e as n,r as t,b as o,d as s,w as y,_ as g}from"./index-P7Lzo4Rg.js";const m={class:"markdown-body"},_=n("div",{class:"tip"},[n("p",null,"1、空数据效果，组件本身没有提供接口，你可以自己实现，这样会更灵活一些")],-1),h=[_],b={__name:"explain",setup(l,{expose:a}){return a({frontmatter:{}}),(u,k)=>(e(),c("div",m,h))}},f={class:"markdown-body"},v=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])],-1),w=n("p",null,"fan-table/data-empty/data-empty",-1),x={__name:"basic",setup(l,{expose:a}){return a({frontmatter:{}}),(u,k)=>{const i=t("vue-anchor"),p=t("demo-block");return e(),c("div",f,[o(i,{"is-edit":"",label:"空数据",fileName:""}),s(),o(p,{filePath:"fan-table/data-empty/data-empty",sourceCode:""},{code:y(()=>[v]),default:y(()=>[w]),_:1})])}}},q={name:"DataEmpty",components:{Explain:b,Basic:x}},N=n("h2",null,"空数据",-1);function $(l,a,r,u,k,i){const p=t("Explain"),d=t("Basic");return e(),c("div",null,[N,o(p),o(d)])}const E=g(q,[["render",$]]);export{E as default};
