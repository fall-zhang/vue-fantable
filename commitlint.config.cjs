...
module.exports = {
  ...
  prompt: {
    ...
    types: [
      ...
      { value: 'perf', name: '性能:    ⚡️  性能提升，算法或者事件优化', emoji: '⚡️' },
      { value: 'test', name: '测试:   ✅  添加测试或已有测试改动', emoji: '✅' },
      { value: 'build', name: '构建:   📦️  构建流程、外部依赖变更（如升级 npm 包、修改 webpack 配置等）', emoji: '📦️' },
      { value: 'revert', name: '回退:   ⏪️  代码回退', emoji: '⏪️' },
      { value: 'tool', name: '工具:   🔧  开发工具变动(构建、脚手架工具等)', emoji: '🔧' },
