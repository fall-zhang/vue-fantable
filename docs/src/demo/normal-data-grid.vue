  ...
  <div class="normal-data-grid">
    <div class="operation">
      ...
      <div class="operation-item">
        ...
        <el-switch v-model="enableColumnFixed" :active-color="switchActiveColor"
          :inactive-color="switchInactiveColor"></el-switch>
      </div>
      <div class="operation-item">
        {{ currentLocal["expand"] }}
        <el-switch v-model="enableExpand" :active-color="switchActiveColor"
          :inactive-color="switchInactiveColor"></el-switch>
      </div>
      <div class="operation-item">
        {{ currentLocal["loading"] }}
        <el-switch v-model="enableLoading" :active-color="switchActiveColor" :inactive-color="switchInactiveColor"
          @change="switchLoading"></el-switch>
      </div>
      <div class="operation-item">
        {{ currentLocal["radio"] }}
        <el-switch v-model="enableRowRadio" :active-color="switchActiveColor"
          :inactive-color="switchInactiveColor"></el-switch>
      </div>
      <div class="operation-item">
        {{ currentLocal["checkbox"] }}
        <el-switch v-model="enableRowCheckbox" :active-color="switchActiveColor"
          :inactive-color="switchInactiveColor"></el-switch>
      </div>
    </div>
