import { addExtension, normalizePath } from '@rollup/pluginutils'
...
import licensePlugin from './rollupLicensePlugin'// console.log(__dirname);
// 只默认加 JS，不判断是否存在？
...
/**
   ...
   * @param {string | false} declarationDir
...
/**
 *
 * @param { Record<string, ShimOptions>} deps
 * @returns  Plugin
 */
